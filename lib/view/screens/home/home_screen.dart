    ...
    return
      GetBuilder<CategoryController>(
        ...
        backgroundColor: Colors
            .white,
        // ResponsiveHelper.isDesktop(context) ? Theme.of(context).cardColor : null,
        body: SafeArea(
                    ...
                    child: Row(children: [
                      ...
                      GestureDetector(
                          onTap: () {
                            ...
                            // Get.to(()=>CouponScreen(fromCheckout: Get.parameters['fromCheckout'] == 'true'),
                            ...
                            image: DecorationImage(
                              ...
                              image: CachedNetworkImageProvider(
                                '${Get
                                    ...
                                    .configModel!
                                    .baseUrls!
                                    .categoryImageUrl}/${categoryController
                        ...
                        child: Column(
                            ...
                            children: [
                              ...
                              _configModel!.popularRestaurant == 1
                                  ...
                                  isPopular: true, imgUrl: 'assets/image/popular_resturants.png',
                                txt1: 'Popular',
                                txt2: "Resturants",
                              colorTxt1: Colors.black,
                              colorTxt2: Colors.red,
                              ...
                              _isLogin
                                  ?  PopularRestaurantView(
                                  isPopular: false,
                                  isRecentlyViewed: true, imgUrl: 'assets/image/recommended.png',
                                txt1: 'Recommended',
                                txt2: "For You",
                                colorTxt1: Colors.grey,
                                colorTxt2: Colors.brown,
                              )
                                  : const SizedBox(),
                              ...
                              _configModel!.newRestaurant == 1
                                  ?  PopularRestaurantView(
                                  isPopular: false, imgUrl: 'assets/image/new_on_ziggoo.png',
                                txt1: 'New On',
                                txt2: "Ziggoo",
                                colorTxt1: Colors.white,
                                colorTxt2: const Color(0xFF00C065),
                              )
                                  : const SizedBox(),
                              const SizedBox(height: 10,),
                              ...
                              Padding(
                                padding:
                                const EdgeInsets.fromLTRB(10, 25, 0, 15),
                                child: Row(children: [
                                  Expanded(
                                      child: Text(
                                        'all_restaurants'.tr,
