        ...
        bottomNavigationBar: ResponsiveHelper.isDesktop(context) ? const SizedBox() : GetBuilder<OrderController>(builder: (orderController) {
            ...
            ? const SizedBox() : BottomAppBar(
              ...
              child: Padding(
                ...
                child: Row(children: [
                  BottomNavItem(iconData: EvaIcons.homeOutline, isSelected: _pageIndex == 0, onTap: () => _setPage(0)),
                  BottomNavItem(iconData: EvaIcons.heart, isSelected: _pageIndex == 1, onTap: () => _setPage(1)),
                  const Expanded(child: SizedBox()),
                  BottomNavItem(iconData: EvaIcons.shoppingBag, isSelected: _pageIndex == 3, onTap: () => _setPage(3)),
                  BottomNavItem(iconData: EvaIcons.person, isSelected: _pageIndex == 4, onTap: () => _setPage(4)),
