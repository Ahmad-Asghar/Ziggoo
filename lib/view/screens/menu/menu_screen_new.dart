            ...
            return Container(
              ...
              child: Padding(
                padding: const EdgeInsets.only(
                  left: 15, right: Dimensions.paddingSizeOverLarge,
                  top: 60,
                  bottom: 5,
                ),
                child: Row(children: [
              ...
              child: Column(children: [
                ...
                Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                  ...
                  Container(
                    ...
                    // ),
                    padding: const EdgeInsets.symmetric(horizontal: 15, vertical: Dimensions.paddingSizeDefault),
                    child: Column(children: [
                ...
                Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                  Padding(
                    ...
                    child: Text(
                      'earnings'.tr,
                      style: robotoMedium.copyWith(fontSize: 20, color: Theme.of(context).primaryColor.withOpacity(0.5)),
                    ),
                  ),
                ...
                Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                  ...
                  Container(
                    ...
                    //   boxShadow: const [BoxShadow(color: Colors.black12, spreadRadius: 1, blurRadius: 5)],
                    // ),
                    padding: const EdgeInsets.symmetric(horizontal: 20, vertical: Dimensions.paddingSizeDefault),
                    child: Column(children: [
