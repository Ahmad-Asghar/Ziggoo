            ...
            Row(children: [
              CircleAvatar(
                radius:14,
                  ...
                  child: const Icon(EvaIcons.star, color: Colors.white, size: 17)),
              const SizedBox(width: Dimensions.paddingSizeExtraSmall),
              Column(
                ...
                children: [
                  Text(
                    ...
                    style: robotoMedium.copyWith(fontSize: 14, fontWeight:FontWeight.bold,color: textColor),
                  ),
        ...
        InkWell(
          ...
          child: Row(children: [
            ...
            Column(
              ...
              children: [
                Text(
                  "Map", textDirection: TextDirection.ltr,
                  style: robotoMedium.copyWith(fontSize: 14, fontWeight:FontWeight.bold,color: textColor),
                ),
                Text("Direction", style: robotoRegular.copyWith(fontSize: Dimensions.fontSizeSmall, color: textColor)),
              ],
            ),
          ]),
        ),
        ...
        Column(children: [
          Row(children: [
            CircleAvatar(
                radius:14,
                backgroundColor:Theme.of(context).primaryColor,
                child: const Icon(Icons.alarm_on_rounded, color: Colors.white, size: 17)),
            const SizedBox(width: Dimensions.paddingSizeExtraSmall),
            Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
