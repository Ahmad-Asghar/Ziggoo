...
class DicountTag extends StatelessWidget {
...
class DiscountTag extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return (discount! > 0 || freeDelivery!) ? Padding(
      ...
      child: Text(
        ...
        style: robotoMedium.copyWith(
          ...
          fontSize: fontSize ?? (ResponsiveHelper.isMobile(context) ? 17 : 12),
        ),
        textAlign: TextAlign.center,
      ),
    ) : const SizedBox();
